...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/nemspy-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15603&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/nemspy-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `nemspy` can be installed with:

```
conda install nemspy
```

It is possible to list all of the versions of `nemspy` available on your platform with:
